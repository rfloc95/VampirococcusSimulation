...
model_params = {"food": UserSettableParameter('checkbox', 'Food Enabled', True),
                ...
                "initial_chromatium": UserSettableParameter('slider', 'Initial Chromatium Population', 137, 1, 200,1),
                "chromatium_reproduce": UserSettableParameter('slider', 'Chromatium Reproduction Rate', 0.3, 0.01, 1.0, 0.01),
                "initial_vampiro": UserSettableParameter('slider', 'Initial Vampiro Population', 99, 1, 200, 1),
